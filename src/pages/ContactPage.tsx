                ...
                <Card className="border-none shadow-sm bg-muted/50 dark:bg-card">
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${CONTACT_DETAILS.phone}`} dir="ltr" style={{ unicodeBidi: 'embed', direction: 'ltr' }} className="text-muted-foreground hover:text-primary transition-colors">{CONTACT_DETAILS.phoneFormatted}</a>
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-none shadow-sm bg-muted/50 dark:bg-card">
